...
export class WonderlandTimeStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class WonderlandTimeStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class WonderlandTimeStaking extends ethereum.SmartContract {
  static bind(address: Address): WonderlandTimeStaking {
    return new WonderlandTimeStaking("WonderlandTimeStaking", address);
  }
  ...
  epoch(): WonderlandTimeStaking__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new WonderlandTimeStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<WonderlandTimeStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint32,uint32)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new WonderlandTimeStaking__epochResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  warmupInfo(param0: Address): WonderlandTimeStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new WonderlandTimeStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<WonderlandTimeStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WonderlandTimeStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
