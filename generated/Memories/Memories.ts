...
export class Memories__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Memories extends ethereum.SmartContract {
  ...
  rebases(param0: BigInt): Memories__rebasesResult {
    let result = super.call(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new Memories__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<Memories__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
